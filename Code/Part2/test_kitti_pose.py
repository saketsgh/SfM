...
from Evaluation.Pose.pose_evaluation_utils import dump_pose_seq_TUM
...
flags.DEFINE_integer("test_seq", 15, "Sequence id to test")
flags.DEFINE_string("dataset_dir", "/media/patodichayan/DATA/733/PFinal/SfM/Code/Part2/Test/", "Dataset directory")
flags.DEFINE_string("output_dir", "/media/patodichayan/DATA/733/PFinal/SfM/Code/Part2/SFMLearner/Output_Pred/Pose_their_model_small_dataset/", "Output directory")
...
#flags.DEFINE_string("ckpt_file", "/media/patodichayan/DATA/733/PFinal/SfMLearner/models/model-100280", "checkpoint file")
#flags.DEFINE_string("ckpt_file", "/media/patodichayan/DATA/733/PFinal/SfMLearner/models/model-190532", "checkpoint file")
FLAGS = flags.FLAGS
...
def load_image_sequence(dataset_dir, 
    ...
    for o in range(-half_offset, half_offset+1):
        ...
        img_file = os.path.join(
            dataset_dir, 'sequences', '%s/image_1/data/%s.png' % (curr_drive, curr_frame_id))
...
def main():
    ...
    img_dir = os.path.join(seq_dir, 'image_1','data')
    ...
    times = np.array([float(s[17:]) for s in times])
