...
parser.add_argument("--gtruth_dir", default="/media/patodichayan/DATA/733/PFinal/SfM/Code/Part2/Misc/Ground_Truth/", 
    help='Path to the directory with ground-truth trajectories')
parser.add_argument("--pred_dir", default = "/media/patodichayan/DATA/733/PFinal/SfM/Code/Part2/SFMLearner/Output_Pred/Pose_their_model_small_dataset/", 
